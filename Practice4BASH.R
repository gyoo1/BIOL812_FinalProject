...
#read sequences 
HCov <- read.FASTA("./Sequences/HCoV-HKU1_NC_006577.fasta", type="DNA")
MERS <- read.FASTA("./Sequences/MERS-CoV_NC_019843.fasta", type="DNA")
SARS <- read.FASTA("./Sequences/SARS-CoV_NC_004718.fasta", type="DNA")
...
DNAalign <- muscle::muscle(stringset = DNAset, quiet = T)
