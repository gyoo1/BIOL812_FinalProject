...
6. As the relationships between SARS-CoV-2 sequences are poorly resolved due to the high sequence similarity, we run steps 1-5 for the 4 SARS-CoV-2 strains in `SARS-CoV-2.R`. The annotated NJ tree with the SARS-CoV-2 sequences only are combined with the full NJ tree: `CoV_cladograms.pdf`
